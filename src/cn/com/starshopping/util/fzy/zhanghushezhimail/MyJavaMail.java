package cn.com.starshopping.util.fzy.zhanghushezhimail;
...
public class MyJavaMail implements Runnable {
    ...
    private String yonghuming;        //收件人的用户名
    private String xinshoujihaoma;    //收件人新修改的手机号码
    private final String option = "8";//Service的请求指令参数

    public MyJavaMail(String email,String yonghuming,String xinshoujihaoma) {  // username 平台用户名
        this.yonghuming = yonghuming;
        this.xinshoujihaoma = xinshoujihaoma;
        this.email = email;
    ...
    public void run() {
        ...
        try {
            ...
            // 6.设置邮件内容
            String content = "<html><head></head><body><h1>这是一封激活邮件,激活请点击以下链接，如果不是本人操作，请勿点击!!(<font color='red'>若成功则自动跳转账户设置页面</font>)</h1><h3>" +
                    "<a href='http://localhost:8080/ZhangHuSheZhiServlet?option="+option+"&yonghuming="+yonghuming+"&xinshoujihaoma="+xinshoujihaoma+"' style='color:#f64a4a'>" +
